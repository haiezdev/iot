...
<head>
    <meta charset="UTF-8">
    <title>Tạo Command List mới</title>
...
<body>
    ...
    <div class="main-content">
        <div class="form-container">
            ...
            <form method="POST" action="{{ route('command-lists.store') }}">
                @csrf
                <input type="text" name="name" placeholder="Tên command list" required>
                <textarea name="description" placeholder="Mô tả"></textarea>
                <textarea name="commands" placeholder="Mỗi dòng 1 lệnh" required style="height:120px;"></textarea>
