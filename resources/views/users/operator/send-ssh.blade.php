...
<head>
    ...
    <style>
        body { margin: 0; font-family:  Arial, sans-serif; display: flex; min-height: 100vh; background: #000; color: #0f0; }
...
const targetIP = '{{ $ip }}';
const socket = new WebSocket('ws://localhost:8080/?ip=' + targetIP);

socket.onopen = function() {
    term.write('Đã kết nối SSH server tới ' + targetIP + '!\r\n');
};
